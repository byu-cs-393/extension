...
//
// The whole body sits in install() because a bare `return` guard isn't
// legal at module top level; the bundler supplies the surrounding scope
// that used to come from a hand-rolled IIFE.
